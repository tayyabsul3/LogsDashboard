...
const Dashboard = () => {
  ...
  return (
    <div className="transition-all duration-300 ease-in-out body p-5 text-sm   lg:pl-10 flex flex-col gap-5 h-[85vh] overflow-y-auto">
      <h1 className="text-white text-2xl tracking-wide lg:mt-5">Dashboard</h1>
        ...
        <div className="flex gap-5 flex-col xl:flex-row w-full">
              ...
              <div className="flex-1">
                ...
                >
                  <div className="flex justify-between text-lg mb-2 ">
                    <h1 className="text-lg">Learn to Use</h1>
              ...
              <div className="text-white flex-1 px-5 flex flex-col gap-1 linear_g_1   py-5 rounded-2xl text-[12px] ">
                <div className="flex justify-between flex-col gap-1 text-2xl mb-2">
                  <div className=" flex justify-between items-center">
                    <h1 className="text-lg">Get One-time Report</h1>
                    <GoKebabHorizontal
          ...
          <div className="w-fit h-full rounded-2xl p-5 flex-[0.3] linear_g_1">
            <div className=" flex justify-between w-full items-center px-5 mb-5 text-white text-xl">
              <h1 className="text-lg">Enviromental Settings</h1>
              <GoKebabHorizontal style={{ transform: "rotate(90deg)" }} />
            </div>
