...
export function PieChartLabelandPer() {
  return (
    <Card className="flex flex-col rounded-2xl bg-blue-950 p-5  border-none text-white">
      <h1 className="text-white   ">Logs by event level</h1>

      <CardContent className="flex-1 py-0 px-3     ">
        <ChartContainer
          config={chartConfig}
          className="mx-auto aspect-square h-fit max-h-[250px]   "
        >
