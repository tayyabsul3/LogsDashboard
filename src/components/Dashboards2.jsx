...
const Dashboards2 = () => {
  return (
    <div className="transition-all duration-300 ease-in-out body text-sm  flex h-[85vh] overflow-y-auto  ">
      <div className="transition-all duration-300 ease-in-out body p-5  lg:px-10 flex-[0.8] overflow-y-auto scrollbar-hide flex flex-col gap-5 h-[85vh]  lg:pr-5 ">
        <h1 className="text-white text-2xl  tracking-wide lg:mt-5">Overview</h1>
      ...
      <div className="flex p-2 flex-col  gap-5 flex-[0.3]  max-lg:flex-[0.3] 2xl:flex-[0.2] linear_g_1  min-h-[85vh] pb-5 h-full overflow-y-auto  ">
